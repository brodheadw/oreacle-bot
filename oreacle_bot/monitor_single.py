# src/monitor_single.py
# Single-cycle version for GitHub Actions
...
def main():
    """Single monitoring cycle for GitHub Actions"""
    ...
    logging.info(f"✅ Single cycle complete. Processed {len(new_items)} new items.")
